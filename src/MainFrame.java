...
public class MainFrame extends JFrame {
    ...
    private JPanel createStep5Panel() {
        ...
        for (Dimension d : activeScenerio.getDimensions()) {
            ...
            panel.add(new JLabel(d.getName() + " Score: " + String.format("%.1f", score)));
        ...
        if (weakest != null) {
            panel.add(new JLabel("--------------------------------------------------"));
            panel.add(new JLabel("Gap Analysis Results:"));
            panel.add(new JLabel("Weakest Dimension: " + weakest.getName()));
            panel.add(new JLabel("Gap Value: " + String.format("%.1f", 5.0 - minScore)));

            String label = minScore >= 4.0 ? "Excellent" : minScore >= 3.0 ? "Good" : "Needs Improvement";
